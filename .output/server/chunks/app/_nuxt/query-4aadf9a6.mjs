...
import { s as asyncDataDefaults, a as useNuxtApp, c as createError, u as useRuntimeConfig } from '../server.mjs';
import { t as withLeadingSlash, j as joinURL, y as withoutTrailingSlash, D as withBase, z as hash } from '../../nitro/node-server.mjs';
import { a as useRequestEvent, u as useContentPreview } from './preview-90cfe883.mjs';
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-75c28b69.mjs').then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query-4aadf9a6.mjs.map
