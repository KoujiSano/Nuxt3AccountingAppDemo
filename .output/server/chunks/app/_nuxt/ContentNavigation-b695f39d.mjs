...
import { u as useContentDisabled, a as useAsyncData, q as queryContent, w as withContentBase, e as encodeQueryParams, b as addPrerenderPath, s as shouldUseClientDB, j as jsonStringify } from './query-5c55592c.mjs';
import { u as useState } from './state-b54abad0.mjs';
import { z as hash } from '../../nitro/node-server.mjs';
import { _ as __nuxt_component_0 } from './nuxt-link-49581fb8.mjs';
import { d as useRuntimeConfig } from '../server.mjs';
import { u as useContentPreview } from './preview-811292cd.mjs';
import 'node:http';
import 'node:https';
import 'fs';
import 'path';
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import('./client-db-6231a300.mjs').then((m) => m.generateNavigation);
...
//# sourceMappingURL=ContentNavigation-b695f39d.mjs.map
