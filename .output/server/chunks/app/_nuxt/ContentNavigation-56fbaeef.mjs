...
import { a as useContentDisabled, u as useAsyncData, q as queryContent, w as withContentBase, e as encodeQueryParams, b as addPrerenderPath, s as shouldUseClientDB, j as jsonStringify } from './query-d2964374.mjs';
import { u as useState } from './state-21b16c03.mjs';
import { z as hash } from '../../nitro/node-server.mjs';
import { _ as __nuxt_component_0 } from './nuxt-link-b0b1f983.mjs';
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import('./client-db-4032a1dc.mjs').then((m) => m.generateNavigation);
...
//# sourceMappingURL=ContentNavigation-56fbaeef.mjs.map
