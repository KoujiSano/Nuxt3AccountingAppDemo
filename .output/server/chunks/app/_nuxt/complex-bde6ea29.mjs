...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(__nuxt_component_5, { options: menu1Options }, null, _parent));
      _push(`</th><th>\u533A\u5206`);
      _push(ssrRenderComponent(__nuxt_component_5, { options: menu2Options }, null, _parent));
      _push(`</th><th>\u4F1A\u8A08\u5358\u4F4D`);
      _push(ssrRenderComponent(__nuxt_component_5, { options: menu3Options }, null, _parent));
      _push(`</th><th>\u6D88\u8CBB\u7A0E`);
      _push(ssrRenderComponent(__nuxt_component_5, { options: menu4Options }, null, _parent));
      _push(`</th><th>\u5BFE\u8C61\u671F\u9593`);
      _push(ssrRenderComponent(__nuxt_component_5, { options: menu5Options }, null, _parent));
...
//# sourceMappingURL=complex-bde6ea29.mjs.map
