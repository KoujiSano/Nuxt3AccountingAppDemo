...
import { A as asyncDataDefaults, a as useNuxtApp, c as createError, u as useRuntimeConfig } from '../server.mjs';
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-21e2edde.mjs').then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query-aa216843.mjs.map
