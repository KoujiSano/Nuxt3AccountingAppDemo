...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`</li><li class="list-group-item"><a href="#" class="card-link">\u88DC\u52A9\u5143\u5E33</a></li></ul></div></div><div class="col"><div class="card"><div class="card-header">\u5E74\u6B21\u6C7A\u7B97</div><ul class="list-group list-group-flush"><li class="list-group-item">`);
  _push(ssrRenderComponent(_component_NuxtLink, {
  ...
  _push(`</li></ul></div></div><div class="col"><div class="card"><div class="card-header">\u5404\u7A2E\u8A2D\u5B9A</div><ul class="list-group list-group-flush"><li class="list-group-item">`);
  _push(ssrRenderComponent(_component_NuxtLink, {
...
//# sourceMappingURL=home-2c075bcf.mjs.map
