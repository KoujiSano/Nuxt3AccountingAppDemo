...
import { d as asyncDataDefaults, e as useNuxtApp, c as createError, a as useRuntimeConfig } from '../server.mjs';
import { x as withLeadingSlash, j as joinURL, t as withoutTrailingSlash, y as withBase, v as hash } from '../../nitro/node-server.mjs';
import { a as useRequestEvent, u as useContentPreview } from './preview-df452045.mjs';
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-158c4085.mjs').then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query-86f9e6f6.mjs.map
