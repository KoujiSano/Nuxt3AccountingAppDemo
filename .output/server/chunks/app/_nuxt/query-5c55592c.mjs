...
import { x as asyncDataDefaults, e as useNuxtApp, c as createError, d as useRuntimeConfig } from '../server.mjs';
import { t as withLeadingSlash, j as joinURL, y as withoutTrailingSlash, A as withBase, z as hash } from '../../nitro/node-server.mjs';
import { a as useRequestEvent, u as useContentPreview } from './preview-811292cd.mjs';
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-6231a300.mjs').then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query-5c55592c.mjs.map
