...
import { a as useContentDisabled, u as useAsyncData, q as queryContent, w as withContentBase, e as encodeQueryParams, b as addPrerenderPath, s as shouldUseClientDB, j as jsonStringify } from './query-4aadf9a6.mjs';
import { u as useState } from './state-21b16c03.mjs';
import { z as hash } from '../../nitro/node-server.mjs';
import { _ as __nuxt_component_0 } from './nuxt-link-8eeb725a.mjs';
import { u as useRuntimeConfig } from '../server.mjs';
import { u as useContentPreview } from './preview-90cfe883.mjs';
import 'node:http';
import 'node:https';
import 'fs';
import 'path';
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import('./client-db-75c28b69.mjs').then((m) => m.generateNavigation);
...
//# sourceMappingURL=ContentNavigation-242aad71.mjs.map
