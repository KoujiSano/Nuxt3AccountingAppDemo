...
import { a as useContentDisabled, u as useAsyncData, q as queryContent, w as withContentBase, e as encodeQueryParams, b as addPrerenderPath, s as shouldUseClientDB, j as jsonStringify } from './query-aa216843.mjs';
import { u as useState } from './state-21b16c03.mjs';
import { z as hash } from '../../nitro/node-server.mjs';
import { _ as __nuxt_component_0 } from './nuxt-link-0dc4ede6.mjs';
import { u as useRuntimeConfig } from '../server.mjs';
import { u as useContentPreview } from './preview-440f3b5b.mjs';
import 'node:http';
import 'node:https';
import 'fs';
import 'path';
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import('./client-db-21e2edde.mjs').then((m) => m.generateNavigation);
...
//# sourceMappingURL=ContentNavigation-a4e7ddd8.mjs.map
