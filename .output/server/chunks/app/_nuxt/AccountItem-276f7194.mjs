...
import { _ as __nuxt_component_4$1 } from './div-09e0ac7d.mjs';
import { _ as __nuxt_component_9$1 } from './button-821c2205.mjs';
import { u as useHead } from './index-3d276797.mjs';
import { _ as _export_sfc, h as hProps, b as hasValue, a as useNuxtApp, u as useRuntimeConfig } from '../server.mjs';
import { withCtx, createTextVNode, createVNode, openBlock, createBlock, createCommentVNode, toDisplayString, Fragment, renderList, useSSRContext, defineComponent, h, computed, ref } from 'vue';
...
import { _ as __nuxt_component_9$2 } from './anchor-624c84b9.mjs';
...
const _sfc_main = {
  data() {
    return {
      activeTavle: "table1",
      items: [
        { code: "001", name: "aaa", kana: "bbb", roma: "ccc", rent: "ddd", subType: "eee", tax: "fff" }
      ]
    };
  },
  methods: {
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  const _component_b_div = __nuxt_component_4$1;
  const _component_b_button = __nuxt_component_9$1;
  ...
  const _component_b_a = __nuxt_component_9$2;
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        _push2(ssrRenderComponent(_component_b_div, { padding: "t-3" }, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              if ($data.activeTavle === "table1") {
                _push3(ssrRenderComponent(_component_b_div, null, {
                  default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                    if (_push4) {
                      _push4(ssrRenderComponent(_component_b_button, {
                        button: "outline-primary",
                        active: "",
                        onClick: ($event) => $options.switchTable("table1"),
                        margin: "e-2",
                        col: "sm-2"
                      }, {
                      ...
                      _push4(ssrRenderComponent(_component_b_button, {
                        ...
                        onClick: ($event) => $options.switchTable("table2"),
                        col: "sm-2"
                      }, {
                        default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                          if (_push5) {
              ...
              return [
                $data.activeTavle === "table1" ? (openBlock(), createBlock(_component_b_div, { key: 0 }, {
                  default: withCtx(() => [
                    createVNode(_component_b_button, {
                      button: "outline-primary",
                      active: "",
                ...
                $data.activeTavle === "table2" ? (openBlock(), createBlock(_component_b_div, { key: 1 }, {
                  default: withCtx(() => [
                    createVNode(_component_b_button, {
                      button: "outline-primary",
                      onClick: ($event) => $options.switchTable("table1"),
                        ...
                        default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                          if (_push5) {
                            ...
                            ssrRenderList($data.items, (item, index) => {
                              _push5(ssrRenderComponent(_component_b_tr, { key: index }, {
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    ...
                                    _push6(ssrRenderComponent(_component_b_td, { "text-alignment": "left" }, {
                                      default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                        if (_push7) {
                                          _push7(`${ssrInterpolate(item.code)}`);
                                        } else {
                                          return [
                                    ...
                                    _push6(ssrRenderComponent(_component_b_td, { "text-alignment": "left" }, {
                                      default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                        if (_push7) {
                                          _push7(`${ssrInterpolate(item.kana)}`);
                                        } else {
                                          return [
                                            createTextVNode(toDisplayString(item.kana), 1)
                                          ];
                                        }
                                      }),
                                      _: 2
                                    ...
                                    _push6(ssrRenderComponent(_component_b_td, { "text-alignment": "left" }, {
                                      default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                        if (_push7) {
                                          _push7(`${ssrInterpolate(item.roma)}`);
                                        } else {
                                          return [
                                            createTextVNode(toDisplayString(item.roma), 1)
                                          ];
                                        }
                                      }),
                                      _: 2
                                    ...
                                    _push6(ssrRenderComponent(_component_b_td, { "text-alignment": "center" }, {
                                      default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                        if (_push7) {
                                          _push7(`${ssrInterpolate(item.rent)}`);
                                        } else {
                                          return [
                                            createTextVNode(toDisplayString(item.rent), 1)
                                          ];
                                        }
                                      }),
                                      _: 2
                                    ...
                                    _push6(ssrRenderComponent(_component_b_td, { "text-alignment": "center" }, {
                                      default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                        if (_push7) {
                                          _push7(`${ssrInterpolate(item.subType)}`);
                                        } else {
                                          return [
                                            createTextVNode(toDisplayString(item.subType), 1)
                                          ];
                                        }
                                      }),
                                      _: 2
                                    ...
                                    _push6(ssrRenderComponent(_component_b_td, { "text-alignment": "center" }, {
                                      default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                        if (_push7) {
                                          _push7(`${ssrInterpolate(item.tax)}`);
                                        } else {
                                          return [
                                            createTextVNode(toDisplayString(item.tax), 1)
                                          ];
                                        }
                                      }),
                                      _: 2
                            ...
                            return [
                              (openBlock(true), createBlock(Fragment, null, renderList($data.items, (item, index) => {
                                return openBlock(), createBlock(_component_b_tr, { key: index }, {
                                  default: withCtx(() => [
                                    createVNode(_component_b_td, {
                                      scope: "row",
                                      "text-alignment": "center"
        ...
        } else if ($data.activeTavle === "table2") {
          _push2(ssrRenderComponent(_component_b_div, null, {
            default: withCtx((_2, _push3, _parent3, _scopeId2) => {
              if (_push3) {
                _push3(ssrRenderComponent(_component_b_table, { bordered: "" }, {
...
//# sourceMappingURL=AccountItem-276f7194.mjs.map
