...
import { u as useContentDisabled, a as useAsyncData, q as queryContent, w as withContentBase, e as encodeQueryParams, b as addPrerenderPath, s as shouldUseClientDB, j as jsonStringify } from './query-86f9e6f6.mjs';
...
import { u as useContentPreview } from './preview-df452045.mjs';
import 'node:http';
import 'node:https';
import 'fs';
import 'path';
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import('./client-db-158c4085.mjs').then((m) => m.generateNavigation);
...
//# sourceMappingURL=ContentNavigation-5052c047.mjs.map
