...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/demo/Darkness_KessanHoukoku_MARK_V1_mp5/SenkaGekkou_info.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const SenkaGekkou_info = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { SenkaGekkou_info as default };
//# sourceMappingURL=SenkaGekkou_info-7a24126e.mjs.map
