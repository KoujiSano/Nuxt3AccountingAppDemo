...
const styles = {
  "node_modules/nuxt/dist/app/entry.js": () => import('./_nuxt/entry-styles.6fa5e8f9.mjs').then(interopDefault),
  ...
  "layouts/default.vue": () => import('./_nuxt/default-styles.52b7db73.mjs').then(interopDefault)
};
